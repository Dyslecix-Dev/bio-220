...
const FlashCards = () => {
  return (
    <section className="relative z-20 mx-auto flex h-full max-w-6xl flex-col items-center justify-center px-4 py-24 md:px-8 md:py-36">
      <h2 className="w-full mb-10 text-5xl text-slate-100 font-semibold border-b-2 border-slate-100">Lab 4</h2>
      ...
      <h2 className="w-full mb-10 text-5xl text-slate-100 text-end font-semibold border-b-2 border-slate-100">Lab 5</h2>
      <div className="mx-auto grid max-w-3xl grid-cols-1 gap-6 sm:grid-cols-2">
